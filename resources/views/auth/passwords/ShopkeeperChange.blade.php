...
<html lang="en">
    <head>
        <title>Shopekeeper Change Password </title>
        <meta charset="UTF-8">
        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100 p-t-90 p-b-30">
                    <form class="login100-form validate-form" method="POST" action="{{ route('shopkeeper.password.update') }}" >
                        @csrf
                        <span class="login100-form-title p-b-40">
                            Shopkeeper Change Password
                        </span>
