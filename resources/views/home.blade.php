        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                <div class="fr__prize__inner">
                    <h2>Size you may know.</h2>
                    <h3>Online Predictor</h3>
                    <a class="fr__btn" href="{{route('calculate')}}">Calculator</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                <div class="fr__prize__inner">
                    ...
                    <h3>Search products by shopkeeper or price.</h3>
                    <a class="fr__btn" href="{{route('live_search')}}">Search</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                <div class="prize__inner">
...
{{--<div class="slider__container slider--one bg__cat--3">
    <div class="slide__container slider__activation__wrap owl-carousel owl-loaded owl-drag">
        <div class="owl-stage-outer">
            <div class="owl-stage"
                 style="transform: translate3d(-3038px, 0px, 0px); transition: all 0s ease 0s; width: 9116px;">
                    ...
                    <div class="single__slide animation__style01 slider__fixed--height">
                        <div class="container">
                            <div class="row align-items__center">
                                <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                    <div class="slide">
                                        <div class="slider__inner">
                                            ...
                                            <h1> Beautiful Designs</h1>
                                            <div class="cr__btn">
                                                <a href="{{route('cart.all')}}" style="background-color: #c2a476;">Shop
                                                    Now</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                    <div class="slide__thumb">
                                        <img src="{{asset('assetss/images/slider/fornt-img/1.jpg')}}"
                                             alt="slider images">
                                    </div>
                                </div>
                            </div>
...
<section class="htc__testimonial__area bg__cat--4">
    <div class="container">
        <div class="row">
            <div class="ht__testimonial__activation clearfix slick-initialized slick-slider">
                ...
                <div aria-live="polite" class="slick-list draggable" style="padding: 0px 10px;">
                    <div class="slick-track"
                         style="opacity: 1; width: 4850px; transform: translate3d(-970px, 0px, 0px);" role="listbox">
                        <div class="col-lg-6 col-md-6 single__tes slick-slide slick-cloned" data-slick-index="-3"
                             aria-hidden="true" tabindex="-1" style="width: 485px;">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('assetss/images/test/client/DSC_8377.JPG')}}"
                        ...
                        <div class="col-lg-6 col-md-6 single__tes slick-slide" data-slick-index="2" aria-hidden="true"
                             tabindex="-1" role="option" aria-describedby="slick-slide02" style="width: 485px;">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('assetss/images/test/client/DSC_8377.JPG')}}"
                                         alt="testimonial images"
                        ...
                        <div class="col-lg-6 col-md-6 single__tes slick-slide slick-cloned" data-slick-index="5"
                             aria-hidden="true" tabindex="-1" style="width: 485px;">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('assetss/images/test/client/DSC_8377.JPG')}}"
                        ...
                        <div class="col-lg-6 col-md-6 single__tes slick-slide slick-cloned" data-slick-index="6"
                             aria-hidden="true" tabindex="-1" style="width: 485px;">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="{{asset('assetss/images/test/client/DSC_8377.JPG')}}"
